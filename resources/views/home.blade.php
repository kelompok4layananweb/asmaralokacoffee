...
<head>
    ...
    <!-- Core Css -->
    <link rel="stylesheet" type="text/css" href="style/assets/css/datatables.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="style/assets/css/bootstrap-slider.css">
...
<body>
    ...
    <div class="br-sideleft">
        ...
        <div class="br-logo d-flex justify-content-center align-items-center">
            <a href="index.html"><img src="style/assets/image/logo.png" alt="MS Admin Panel" width="80" /></a>
        </div>
        <ul class="custom-scroll">
            <li class="active"><a href="index.html" class="waves-effect waves-primary"><i
                        class="la la-dashboard"></i>Dashboard</a></li>
            <li class="dropdown-sub-menu">
                <a href="{{ route('customers.index') }}" class="waves-effect waves-primary">
                ...
                <nav class="nav">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-header py-0" aria-labelledby="dropdownNOTY">
                            ...
                            <div class="media-list">
                                ...
                                <a href="" class="media-list-link">
                                    <div class="media d-flex align-items-center py-2 px-2">
                                        <img src="style/assets/image/img1.jpg" width="50" class="rounded-circle" alt="">
                                        <div class="media-body pl-3">
                                            <div class="d-flex align-items-center justify-content-between mb-1">
                    ...
                    <div class="dropdown">
                        <a href="" class="nav-link-profile d-flex dropdown-toggle" data-toggle="dropdown"
                            id="dropdownprofile">
                            <img src="style/assets/image/img3.jpg" class="rounded" alt="" width="50">
                ...
                <div class="card-body">
                    ...
                    <ul class="buuton-group">
                        ...
                        <li><button type="button"
                                class="btn btn-primary btn-md waves-effect waves-primary">Medium</button></li>
                        <li><button type="button"
                                class="btn btn-primary btn-lg waves-effect waves-primary">Large</button></li>
                    </ul>
                    <hr class="border-dashed my-4">
                    <h6 class="mb-4">Default Outline Buttons</h6>
                    <ul class="buuton-group">
                        <li><button type="button"
                                class="btn btn-outline-primary waves-effect waves-primary">Primary</button></li>
                        <li><button type="button"
                                class="btn btn-outline-secondary waves-effect waves-light">Secondary</button>
                        </li>
                        <li><button type="button"
                                class="btn btn-outline-success waves-effect waves-green">Success</button></li>
                        <li><button type="button" class="btn btn-outline-danger waves-effect waves-red">Danger</button>
                        </li>
                        <li><button type="button"
                                class="btn btn-outline-warning waves-effect waves-yellow">Warning</button></li>
                        <li><button type="button"
                                class="btn btn-outline-light waves-effect waves-primary">Light</button>
                        </li>
                        <li><button type="button" class="btn btn-link waves-effect waves-primary">Link</button>
                        </li>
                        <li>
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            ...
                            <div class="form-group">
                                <div class="input-group bg-light">
                                    ...
                                    <input type="text" class="form-control pl-1" placeholder="Name" aria-label="Name"
                                        aria-describedby="Name">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group bg-light">
                                    <input type="text" class="form-control" placeholder="Name" aria-label="Name2"
                                        aria-describedby="Name">
                                    <div class="input-group-prepend">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-feedback text-danger"><i
                                                class="la la-info-circle mr-2"></i>This is error text</div>
                                    </div>
                                    <div class="form-group">
                                        <label>Label<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control border-success" placeholder="Filed">
                                        <div class="form-control-feedback text-success"><i
                                                class="la la-check-circle mr-2"></i>Succeed text</div>
                                    </div>
                                    <div class="form-group">
                                        <label>Label<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control border-warning" placeholder="Filed">
                                        <div class="form-control-feedback text-warning"><i
                                                class="la la-exclamation-triangle mr-2"></i>Warning text</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table id="datatable1" class="table table-striped table-borderless w-100">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton"
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton1"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton2"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton3"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton4"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton5"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton6"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton7"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton8"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton9"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                            ...
                            <table id="datatable2" class="table table-striped table-borderless w-100">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton10"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton11"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton12"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton13"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton14"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton15"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton16"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton17"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton18"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <div class="dropdown">
                                                <a class="la la-ellipsis-h dropdown-toggle" id="dropdownMenuButton19"
                                                    data-toggle="dropdown" aria-haspopup="true"
                                                    aria-expanded="false"></a>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-5 mb-5 mb-lg-0">
                            ...
                            <div class="progress mb-5">
                                <div class="progress-bar progress-bar-striped bg-primary progress-bar-animated progress-primary"
                            ...
                            <div class="progress mb-5">
                                <div class="progress-bar progress-bar-striped bg-success progress-bar-animated progress-success"
                            ...
                            <div class="progress mb-5">
                                <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated progress-danger"
                                    role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
                                    style="width: 80%;">
                                    <div class="progress-value progress-value-top">80%</div>
                                </div>
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-warning progress-bar-animated progress-warning"
                                    role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"
                                    style="width: 80%;">
                                    <div class="progress-value progress-value-top">80%</div>
                                </div>
                        ...
                        <div class="col-12 col-lg-6 offset-lg-1">
                            ...
                            <ul class="mb-5 row">
                                <li class="col-6 col-lg-3">
                                    <a data-custom-class="tooltip-primary" data-toggle="tooltip" data-placement="top"
                                        title="Tooltip Top Primary" class="text-primary">
                                        Tooltip Top <i class="la la-info-circle"></i></a>
                                </li>
                                <li class="col-6 col-lg-3">
                                    <a data-custom-class="tooltip-success" data-toggle="tooltip" data-placement="right"
                                        title="Tooltip Right Success" class="text-success">
                                        Tooltip Right <i class="la la-info-circle"></i></a>
                                </li>
                                <li class="col-6 col-lg-3">
                                    <a data-custom-class="tooltip-danger" data-toggle="tooltip" data-placement="bottom"
                                        title="Tooltip Bottom Danger" class="text-danger">
                                        Tooltip Bottom <i class="la la-info-circle"></i></a>
                                </li>
                                <li class="col-6 col-lg-3">
                                    <a data-custom-class="tooltip-warning" data-toggle="tooltip" data-placement="right"
                                        title="Tooltip Left Warning" class="text-warning">
                                        Tooltip Left <i class="la la-info-circle"></i></a>
                                </li>
                            </ul>
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="slider-wrapper slider-primary my-5">
                                        <input class="input-range" data-slider-id='ex1Slider'
                                            data-slider-tooltip="always" type="text" data-slider-min="0"
                                            data-slider-max="100" data-slider-step="1" data-slider-value="80" />
                                    </div>
                                    <div class="slider-wrapper slider-success my-5">
                                        <input class="input-range" data-slider-id='ex2Slider'
                                            data-slider-tooltip="always" type="text" data-slider-min="0"
                                            data-slider-max="100" data-slider-step="1" data-slider-value="50" />
                                    </div>
                                    <div class="slider-wrapper slider-warning my-5">
                                        <input class="input-range" data-slider-id='ex3Slider'
                                            data-slider-tooltip="always" type="text" data-slider-min="0"
                                            data-slider-max="100" data-slider-step="1" data-slider-value="90" />
                                    </div>
                                    <div class="slider-wrapper slider-danger my-5">
                                        <input class="input-range" data-slider-id='ex4Slider' data-slider-value="40, 70"
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="slider-range slider-primary my-5">
                                        <input class="input-range" data-slider-id='ex5Slider' type="text"
                                            data-slider-min="0" data-slider-max="100" data-slider-step="1"
                                            data-slider-value="80" data-slider-handle="square" />
                                    </div>
                                    <div class="slider-range slider-success my-5">
                                        <input class="input-range" data-slider-id='ex6Slider' type="text"
                                            data-slider-tooltip="always" data-slider-min="0" data-slider-max="100"
                                            data-slider-step="1" data-slider-value="40" data-slider-handle="square" />
                                    </div>
                                    <div class="slider-range slider-warning my-5">
                                        <input class="input-range" data-slider-id='ex7Slider' type="text"
                                            data-slider-min="0" data-slider-max="100" data-slider-step="1"
                                            data-slider-value="60" data-slider-handle="square" />
                                    </div>
                                    <div class="slider-range slider-danger my-5">
                                        <input class="input-range" data-slider-id='ex8Slider' type="text"
                                            data-slider-min="0" data-slider-max="100" data-slider-step="1"
                                            data-slider-value="40, 80" data-slider-handle="square" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script src="style/assets/scripts/Chart.min.js"></script>
<script src="style/assets/scripts/dashboard.js"></script>
